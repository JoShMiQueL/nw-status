...
import type { EventConfiguration } from '../domain/events';
import { DEFAULT_EVENT_CONFIG } from '../domain/events';
...
export class ConfigService implements IConfigService {
  ...
  private loadEnvConfig(): void {
    ...
    this.config.set(
      'HISTORY_FILE',
      process.env.HISTORY_FILE || storage.historyFile || 'data/history.json'
    );
  }
}
